...
import static es.florida.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import es.florida.IntegrationTest;
import es.florida.config.Constants;
import es.florida.domain.User;
import es.florida.repository.AuthorityRepository;
import es.florida.repository.UserRepository;
import es.florida.security.AuthoritiesConstants;
import es.florida.service.UserService;
import es.florida.service.dto.AdminUserDTO;
import es.florida.service.dto.PasswordChangeDTO;
import es.florida.service.dto.UserDTO;
import es.florida.web.rest.vm.KeyAndPasswordVM;
import es.florida.web.rest.vm.ManagedUserVM;
